...
package com.qrcode.scanner.googlelib
 ...
 */
class QrCodeDrawable(val qrCodeViewModel: QrCodeViewModel) : Drawable() {
    private val boundingRectPaint = Paint().apply {
        style = Paint.Style.FILL    // 2023.05.13: from STROKE to FILL
        color = Color.YELLOW
        strokeWidth = 5F
        alpha = 150                 // 2023.05.13: from 200 to 150
    }
